...
@section('content')
    <div class="container">
                ...
                @if(asset($pro))
                    <div class="col-sm-3 product-price">
                        <div class="single-item">
                            <div class="single-item-header product-img" style="margin-top: 20px">
        ...
        <div class="row" >
            ...
            @foreach($spkm as $sp)
                <div class="col-sm-3 products-sale">
                    <div class="single-item">
                        <div class="single-item-header product-img">
