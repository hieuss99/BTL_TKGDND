...
<nav class="navbar navbar-inverse" style="position: relative">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a  class="navbar-brand aHead" href="{{route('home')}}"><img id="logo" class="img-fluid" src="{{asset('img/Logo/logo.png')}}" style="height: 80px;width: 80px;position: relative;bottom: 150%"></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav" style="margin-left: 50px">
                <li style="width: 130px ;padding-left: 0px" ><a  href="{{route('home')}}" ><i class="fas fa-home" ></i>Trang chủ</a></li>


                    <li class="dropdown mydropdownjQuery"  style="width: 130px ">
                        <a  class="dropdown-toggle type-product" data-toggle="dropdown" href="#" style="text-align: center"><i class="fab fa-product-hunt"></i>Sản phẩm
                            <ul class="dropdown-menu" style="text-indent: 10px" >
                                @foreach($prod as $sp)
                ...
                <li style="width: 150px ; margin-left: 30px"><a  href="https://www.facebook.com/profile.php?id=100012878358362"><i class="fab fa-facebook"></i>Liên hệ</a></li>
            ...
            <form class="navbar-form navbar-left search-form" method="get" action="{{route('searchall')}}">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Tìm kiếm" size="30" name="key" style="width: 400px ; margin-left: 30px">
            ...
            <ul class="nav navbar-nav  navbar-right user-logged"  >
                @if (\Illuminate\Support\Facades\Auth::check())
                    <div class="dropdown" style="float: left;margin-left: -80px;margin-top: 10px">
                        <span class="glyphicon glyphicon-user" style="margin-right: 5px"></span>
                        <span class="dropdown-toggle" id="email" data-toggle="dropdown"><a style="color: whitesmoke;font-size:medium;margin-right: 10px"  href="#">{{\Illuminate\Support\Facades\Auth::user()->name}}<span class="caret"></span></a></span>
                    ...
                    <li style="border: solid #d5d5d5 ;width: 1px; height: 35px; margin-top: 5px; margin-left: 5px;margin-right: 5px"></li>
                    <div class="giohang dropdown" style="margin-top: 3px">
                ...
                @else
                        <li style="width: 120px"><a href="{{route('reguser')}}" target="_parent"><span class="glyphicon glyphicon-user"></span>Đăng ký</a></li>
                        <li style="border: solid #d5d5d5 ;height: 35px; margin-top: 10px; margin-left: 5px;margin-right: 0px"></li>
                        <li style="width: 150px"><a href="{{route('login')}}" target="_parent"><span class="glyphicon glyphicon-log-in"></span>Đăng nhập</a></li>
                @endif
